...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.SubContent
    ref={ref}
    className={cn(
      "z-50 min-w-[8rem] overflow-hidden rounded-md border border-border-light bg-card p-1 text-card-foreground shadow-card-hover transition-opacity data-[state=open]:duration-[120ms] data-[state=closed]:duration-[80ms] ease data-[state=open]:opacity-100 data-[state=closed]:opacity-0",
      className,
    )}
    {...props}
  />
